package com.ohanyan.goro.sneakersshop.ui.MyFavorite
...
class MyFavoriteFragment : Fragment(), MyFavoriteAdapter.OnItemClickListener {
    ...
    override fun onCreateView(
      ...
      //  viewModel.delete()
        ...
        var myadapter= MyFavoriteAdapter(requireContext(),this)
