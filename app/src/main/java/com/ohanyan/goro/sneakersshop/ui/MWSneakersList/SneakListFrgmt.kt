...
class SneakListFrgmt(var male:String) : Fragment(), SneakerListAdapter.OnItemClickListener {

    lateinit var SneakerList: RecyclerView
    lateinit var sneakerViewModel: SneakerViewModel
    lateinit var loadpr:ProgressBar
    private lateinit var fradapter: SneakerListAdapter
    ...
    private fun setUpRecyclerView() {
        ...
        fradapter = SneakerListAdapter(requireContext(), options, this)
